...
public class NameNode implements ClientProtocol, DatanodeProtocol,
  ...
  */
  ...
  Configuration tmpConf; //add by guoleitao for nn ha
   ...
   * I think this fuc will not be invoked by any hightavailability
   * but still add it here
   * */
  public static InetSocketAddress getDNProtocolAddress(Configuration conf) {
      String dnAddressString = conf.get( "dfs.namenode.dn-address");
  ...
  private void initialize(Configuration conf) throws IOException {
    this.tmpConf = conf; //add by guoleitao, 20121217
  ...
  /**
   * the following add by guoleitao for namenode ha, 20120819
   * */
