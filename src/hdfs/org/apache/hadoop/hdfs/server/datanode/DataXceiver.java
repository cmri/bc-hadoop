...
class DataXceiver extends Thread implements Runnable, FSConstants {
  ...
  public DataXceiver(Socket s, DataNode datanode, 
    ...
    //dataXceiverServer.childSockets.put(s, s); //del by guoleitao, 20120517,  HDFS-2286 & HDFS-2452
  ...
  public void run() {
    ...
    int opsProcessed = 0;
    dataXceiverServer.childSockets.put(s, s);//add by guoleitao, 20120517,  HDFS-2286 & HDFS-2452
    try {
