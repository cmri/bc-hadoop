...
//  private DataStorage storage = null; //del by guoleitao
  DataStorage storage = null;	//add by guoleitao
//  private HttpServer infoServer = null;  //del by guoleitao
  HttpServer infoServer = null; //add by guoleitao
  DataNodeMetrics myMetrics;
  private static InetSocketAddress nameNodeAddr;
//  private InetSocketAddress selfAddr; //del by guoleitao
  InetSocketAddress selfAddr; //add by guoleitao
  private static DataNode datanodeObject = null;
//  private Thread dataNodeThread = null;//del by guoleitao
  Thread dataNodeThread = null;//add by guoleitao
  String machineName;
//  private static String dnThreadName; //del by guoleitao
  static String dnThreadName; //add by guoleitao
  int socketTimeout;
...
//  private boolean connectToDnViaHostname; //del by guoleitao
  boolean connectToDnViaHostname;  //add by guoleitao
//  private boolean relaxedVersionCheck;  //del by guoleitao
  boolean relaxedVersionCheck; //add by guoleitao
  ...
  /** Activated plug-ins. */
//  private PluginDispatcher<DatanodePlugin> pluginDispatcher; //del for nn ha, guoleitao
  public PluginDispatcher<DatanodePlugin> pluginDispatcher;	//add for nn ha, guoleitao
...
//  private static final String DEFAULT_DATA_DIR_PERMISSION = "700"; //del by guoleitao
  static final String DEFAULT_DATA_DIR_PERMISSION = "700"; //add by guoleitao
...
//  private SecureResources secureResources = null; //del by guoleitao
  SecureResources secureResources = null; //add by guoleitao
...
//  private void notifyNamenode(int dpCode, String msg) { //del by guoleitao for nn ha
  public void notifyNamenode(int dpCode, String msg) { //add by guoleitao for nn ha
    try {
...
//  private static class BlockRecord { //del by guoleitao
  static class BlockRecord { //add by guoleitao, for nn ha, 20121009
    final DatanodeID id;
...
//  private LocatedBlock syncBlock(Block block, List<BlockRecord> syncList,//del by guoleitao, 20130105
  public LocatedBlock syncBlock(Block block, List<BlockRecord> syncList,//add by guoleitao, 20130105
      DatanodeInfo[] targets, boolean closeFile) throws IOException {
    if (LOG.isDebugEnabled()) {
